...
int main()
{
    ...
    while (1)
    {
        ...
        printf("-------------------------- 5 修改学生信息---------------------------------------\n\n");
        printf("-------------------------- 6 增加学生信息---------------------------------------\n\n");
        printf("-------------------------- 7 将学生的语文成绩从大到小排序-----------------------\n\n");
        printf("-------------------------- 8 将学生的数学成绩从大到小排序-----------------------\n\n");
        printf("-------------------------- 9 将学生的英语成绩从大到小排序-----------------------\n\n");
        printf("-------------------------- 10 将学生的总成绩从大到小排序------------------------\n\n");
        printf("-------------------------- 11 退出程序----------------------------------------\n\n");
        printf("================================================================================\n\n");
        printf("\n请选择操作命令;\n");
        scanf("%d", &Item);
...
struct Student *Initialize(struct Student *pArr, int len) /*定义一个输入函数，用于输入学生的信息*/
{
